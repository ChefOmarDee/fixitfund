				...
				<form onSubmit={handleSubmit} className="space-y-6">
					<div>
						...
						<input
							...
							type="text"
							required
							className="w-full p-3 border border-black rounded-md focus:ring-blue-500 focus:border-blue-500 text-black"
					...
					<div>
						...
						<input
							...
							className="w-full border border-black rounded-md focus:ring-blue-500 focus:border-blue-500 text-black"
						/>
					</div>
					...
					<div>
						...
						>
							...
							<option value="infrastructure addition">
